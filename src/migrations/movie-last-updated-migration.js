...
;(async () => {
  try {
    const host = "mongodb+srv://mflixAppUser:mflixAppPwd@cluster0.tbrlv.mongodb.net/sample_mflix?retryWrites=true&w=majority"
    ...
    console.log("-----------------movies to migrate: ", moviesToMigrate)
